...
# MAGIC       group provisioning,
# MAGIC 
# MAGIC       which could indicate privilege escalation or lateral movement preparation by
# MAGIC       a threat actor.
# MAGIC 
# MAGIC       '
# MAGIC     taxonomy: []
# MAGIC dscc-tests:
...
display(group_created(earliest="2020-01-01", latest="2025-02-25"))